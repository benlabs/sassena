...
ELSE(Hdf5_INCLUDE_DIRS)
  ...
  FIND_LIBRARY(HDF5_LIBRARY1 hdf5_cpp ${TRIAL_LIBRARY_PATHS})
  SET(HDF5_LIBRARIES ${HDF5_LIBRARY1} ${HDF5_LIBRARIES})
  FIND_LIBRARY(HDF5_LIBRARY2 hdf5 ${TRIAL_LIBRARY_PATHS})
  SET(HDF5_LIBRARIES ${HDF5_LIBRARY2} ${HDF5_LIBRARIES})
